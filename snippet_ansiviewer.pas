...
Type
  ...
  Function AnsiViewer (FName: String; SBAttr:Byte):char; OverLoad;
...
Function AnsiViewer (FName: String; SBAttr:Byte):char;
Var
    ...
    If Ch=#0 Then Begin
      ...
      Case Ch of
        ...
        #80 : If TopLine + WinSize <= Ansi.Lines Then Begin
                ...
                Update;
              End;
        keycursorleft: begin result:=keycursorleft;done:=true;end;
        keycursorright : begin result:=keycursorright;done:=true;end;
